...
public class BigTile {
    ...
    public BigTile(Context context) {
    	mLetterFontSize = context.getResources().getDimensionPixelSize(R.dimen.big_tile_letter);
    	mValueFontSize = context.getResources().getDimensionPixelSize(R.dimen.big_tile_value);
